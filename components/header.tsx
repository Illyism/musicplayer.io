      ...
      <Dialog open={isKeyboardModalOpen} onOpenChange={setIsKeyboardModalOpen}>
        <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
          ...
          <div className="space-y-6 mt-4">
            {/* Playback Controls */}
            <div>
              <h3 className="text-sm font-semibold text-muted-foreground mb-3 uppercase tracking-wider">Playback</h3>
              <div className="space-y-2">
                <div className="flex items-center justify-between py-2 px-3 rounded-md hover:bg-secondary/50">
                  ...
                  <kbd className="px-2 py-1 text-xs font-semibold bg-secondary border border-border rounded">Space</kbd>
                </div>
                <div className="flex items-center justify-between py-2 px-3 rounded-md hover:bg-secondary/50">
                  <span className="text-sm">Next Track</span>
                  <kbd className="px-2 py-1 text-xs font-semibold bg-secondary border border-border rounded">→</kbd>
                </div>
                <div className="flex items-center justify-between py-2 px-3 rounded-md hover:bg-secondary/50">
                ...
                <div className="flex items-center justify-between py-2 px-3 rounded-md hover:bg-secondary/50">
                  ...
                  <kbd className="px-2 py-1 text-xs font-semibold bg-secondary border border-border rounded">S</kbd>
                </div>
              </div>
            </div>
            ...
            {/* Volume Controls */}
            <div>
              <h3 className="text-sm font-semibold text-muted-foreground mb-3 uppercase tracking-wider">Volume</h3>
              <div className="space-y-2">
                <div className="flex items-center justify-between py-2 px-3 rounded-md hover:bg-secondary/50">
                ...
                <div className="flex items-center justify-between py-2 px-3 rounded-md hover:bg-secondary/50">
                  ...
                  <kbd className="px-2 py-1 text-xs font-semibold bg-secondary border border-border rounded">M</kbd>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center justify-between py-2 px-3 rounded-md hover:bg-secondary/50">
                  ...
                  <kbd className="px-2 py-1 text-xs font-semibold bg-secondary border border-border rounded">Esc</kbd>
                </div>
              </div>
            </div>
          </div>
